---
name: solana-bounty-hunter3v2
version: 3.1.0
description: Solana bug bounty SWARM — 34 agents attack in parallel. Bandit-criminal asks "how do I steal $1M?", experts find KyberSwap-style fee_growth bugs, Gate-7 blocks bad submissions. User says "sigamos cazando" → Claude launches ALL agents in bash (&), NO permission. Reputation @LongNetty3803 protected via 7 pre-submission checks. KAST/Adevar rejections never repeat.
---

# (Content identical to solana-bounty-hunter3-v3.1.md)
---
